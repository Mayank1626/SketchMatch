...
public class DashboardController implements Initializable {
    ...
    public void dragSketch() {
        ...
        new_eye.setOnMouseDragged(event -> drag(event));
    ...
    File directory = new File("C:\\Users\\mayan\\Downloads\\SketchMatch_Outputs");
    ...
    // Convert the AnchorPane to an image (fx_id of AnchorPane)
    Image snapshot = sketch.snapshot(null, null);

    // Open the Save File dialog
    File file = fileChooser.showSaveDialog(stage);

    // Save the image if a file is selected
    if (file != null) {
        try {
